...
execute @a[tag=!nfeature] ~~~ function feature
...
execute @a[hasitem={location=slot.weapon.mainhand,item=blade:balkonw}] ~~~ function blade/slashblade

execute @a[hasitem={location=slot.weapon.mainhand,item=blade:balkons}] ~~~ function blade/slashblade

execute @a[hasitem={location=slot.weapon.mainhand,item=blade:balkoni}] ~~~ function blade/slashblade

execute @a[hasitem={location=slot.weapon.mainhand,item=blade:balkong}] ~~~ function blade/balkong

execute @a[hasitem={location=slot.weapon.mainhand,item=blade:balkond}] ~~~ function blade/slashblade
...
execute @a[hasitem={location=slot.weapon.mainhand,item=blade:lightsaber}] ~~~ function blade/lightsaber
...
execute @a[hasitem={location=slot.weapon.mainhand,item=blade:sange }] ~~~ function blade/sange
